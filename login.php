...
<div class="login-form">
    <form action="/examples/actions/confirmation.php" method="post">
        <h2><font style='font-size: x-small;'>BearCubic's</font><br><font style="color:gray;text-align:center;">Bear</font>Money</h2> 
    ...
    <p class="text-center"><a href="#">Solicitar Acesso</a></p>
</div>
</body>
</html>                                		